...
export class ErrorBoundary extends Component<Props, State> {
  ...
  private reportError = (error: Error, errorInfo: ErrorInfo) => {
    // Can integrate error monitoring service here (e.g., Sentry)
  ...
  private handleRetry = () => {
    if (this.retryCount < this.maxRetries) {
      this.retryCount++;
      console.log(
        `[ErrorBoundary] Retrying... (${this.retryCount}/${this.maxRetries})`,
      );
      ...
      console.warn(
        "[ErrorBoundary] Max retries reached, please refresh the page",
      );
    }
  };
  ...
  render() {
    if (this.state.hasError) {
      // If there is a custom fallback, use it
...
// Higher-order component version for wrapping functional components
